...
<script type="text/javascript">
	$(function() {
		$("input[type='button']")
				.click(
						function() {
							document.location.href = this.id.split("#")[0] == 'del' ? 'deleteCounsel.do?no='
									+ this.id.split("#")[1]
									: 'modifyCounsel.do?no='
											+ this.id.split("#")[1];
	...
	<div>
		...
		<div class="moddel">
			<a href="#"><input type="button" value="수정"
				id="mod#${selectInfoCounsel.no}"></a> <a href="#"><input
				type="button" value="삭제" id="del#${selectInfoCounsel.no}"></a>
		</div>

		<table class="nl_form">
			<thead class="nl_head">
				<tr id="nl_head_bar">
					<th id="no">${selectInfoCounsel.no}</th>
					<th id="title">${selectInfoCounsel.title}</th>
					<th id="fileex"><a href="#">${selectInfoCounsel.studno}</a></th>
				</tr>
			</thead>
			<tbody class="nl_body">
				<tr>
					<td colspan="3">
						<p></p> <!-- 여백 -->
						<p></p> <!-- 여백 --> <span> ${selectInfoCounsel.contents} </span>
						<p></p> <!-- 여백 -->
						<p></p> <!-- 여백 -->
					</td>
				</tr>
		...
		<div class="listback">
			<a href="/web/listCounsel.do"><input type="button" value="목록"
				id="listbt"></a>
		</div>
