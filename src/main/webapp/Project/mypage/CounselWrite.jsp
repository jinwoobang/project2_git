...
<body>
	...
	<form action="/web/insertCounsel.do" method="post" name="cFrm">
		...
		<div class="textbox">
			<table class="write_form">
				...
				<tbody>
					<td><textarea name="contents" rows="30" cols="145"></textarea>
					</td>
				</tbody>
			</table>
		</div>
		...
		<div class="write_bottom">
			...
			<a href="/web/listCounsel.do"><input id="cSubmit" type="submit" value="등록하기"></a>
		</div>
	</form>
</body>
