...
<div class="notice_title">
  ...
  <table class="nl_form">
    <thead class="nl_head">
      <tr id="nl_head_bar">
        <th id="no">${selectInfoNotice.no}</th>
        <th id="title">${selectInfoNotice.title}</th>
        <th id="writer">${selectInfoNotice.adminNo}</th>
        <th id="regdate">${selectInfoNotice.regdate}</th>
      </tr>
    </thead>
    <tbody class="nl_body">
      <tr>
        <td colspan="4">
          <p></p>
          <p></p>
          <span><img alt="" src="/web/Project/images/mainimg.jpg" style="width: 700px; height: 700px;"></span>
          <p>${selectInfoNotice.contents}</p>
          <p></p>
        </td>
      </tr>
    </tbody>
    ...
    <div class="listback">
      <a href="/web/listNotice.do"><input type="button" value="목록" id="listbt"></a>
    </div>
