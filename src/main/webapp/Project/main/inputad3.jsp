...
<div class="strength_form">
		<ul class="strength_main">
			...
			<li><img alt="" src="/web/Project/images/leveltest.jpg" width="530px" height="600px"></li>
		</ul>
		<ul class="strength_main">
			<li id="number_n">SECOND.</li>
			<li id="text_n">누구든 수강가능</li>
			<li><img alt="" src="/web/Project/images/everyone.jpg" width="530px" height="600px"></li>
		</ul>
		<ul class="strength_main">
			<li id="number_n">THIRD.</li>
			<li id="text_n">실력 인증된 강사진</li>
			<li><img alt="" src="/web/Project/images/teacher.jpg" width="530px" height="600px"></li>
		</ul>
		<ul class="strength_main">
			<li id="number_n">FOURTH.</li>
			<li id="text_n">수강생 만족도 최상</li>
			<li><img alt="" src="/web/Project/images/thumb.jpg" width="530px" height="600px"></li>
		</ul>
