...
<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" id="boxsize5">
      ...
      <form class="form-signin" method="POST" onSubmit="logincall();return false">
        <h5 class="form-signin-heading" id="login-head1">수정이 <br>완료되었습니다.</h5>
        <img src="/web/Project/images/check2.png" id="check-img">
        <button id="btn-login" class="loginend-but" type="button" onclick="location.href='/web/Project/index.jsp'">메인으로</button>
