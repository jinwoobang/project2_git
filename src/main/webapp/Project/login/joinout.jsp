...
$(function(){
	$("button#out1").click(function(){
		...
		document.location.href='/web/drop.do?id='+"${id}";
	});
});
...
<h5 class="joinout-head" id="">Orda Education 회원 탈퇴</h5>
        ...
        <button id="btn-out2" class="joinout-but" type="button" id="back1" onclick="location.href='/web/Project/mypage/page.jsp'">돌아가기</button>
