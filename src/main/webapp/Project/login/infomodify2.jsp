...
<script type="text/javascript">
function showPopup1() { window.open("pwmod3.jsp", "a", "width=480, height=352, left=100, top=50"	); }
...
<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" id="boxsize8">
		...
		<div class="card-body">
      <form class="form-signin" method="POST" name="frm" action="/web/infoModify2.do">
